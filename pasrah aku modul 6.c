...
int j, k, l, m, pilih;
char hapus[100], update[100], search[100], nama1[100], nama2[100], nama[100], nim[100], kelas[100], dosen[100];
char nim_kr[100];
...
int create_data(){
	...
	printf("\n");
		...
		for (j=0; j<2; j++){
            ...
            {
            	printf("NIM Praktikan tidak boleh ada Spesial Karakter...\n\n");
                fclose(data);
				fclose(data1);
                return main();
            }
        ...
        for (j=2; j<17; j++){
			...
			{
	    		printf("NIM Praktikan kurang dari 17 karakter...\n\n");
				fclose(data);
				fclose(data1);
				return main();
			}
